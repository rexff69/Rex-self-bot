...
const { USER_AGENT, Properties } = require('./constants.cjs');
const { QuestManager } = require('./questManager.cjs'); // Circular dependency? Be careful.
...
class ClientQuest extends Client {
    ...
    async fetchQuests() {
        ...
        const { QuestManager } = require('./questManager.cjs');
